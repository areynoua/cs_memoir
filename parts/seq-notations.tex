...
With $\set$ a set, a \emph{sequence} of elements of $\set$ is a list of its elements in a given order.
...
\begin{itemize}
  ...
  \item $\slice{\sit_i}{\sit_j} = \bodySeq{i}{j}$ is the subsequence of $\seq$ starting from $\sit_i$ and ending with $\sit_j$.\\
    ...
    We consider by convention: for the end bound, its last occurrence; and for the start bound, its last occurrence occurring before the end bound.
