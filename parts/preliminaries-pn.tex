...
We present it restricted to this context.

The idea is to compute and refine simultaneously an over- and an under-approximation of the coverability set of the \ac{PN} until one or the other allows to conclude.
...
\]
At step $i$, the algorithm computes $\Sous(\tupleN, C_i)$ defined as the graph $\langle C_i, \marqi, \sousrel \rangle$
