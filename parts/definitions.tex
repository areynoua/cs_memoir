...
\begin{defi}[initialized (parametric) Petri net]
...
\todo{Note difference when talking about {\greekfont{}ω}-Petri nets}
...
\begin{defi}[Instantiation of \aclp{PPN}]
...
\subsection{Behavioural properties of \aclp{PN}}
