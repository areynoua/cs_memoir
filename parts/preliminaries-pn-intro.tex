...
\begin{lemm}
	...
	The existence of a self-covering sequence is a necessary and sufficient condition for the \emph{non-termination} of a PN (\lang{i.e.} there exists an infinite sequence of transitions $\seqt$ enabled in $\mar_0$).
\end{lemm}
