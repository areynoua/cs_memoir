...
\begin{proof}
  ...
  However, as the number of places is finite, we will eventually reach a marking where all places will be marked with an $\omega$, \lang{i.e.}, which can not have a successor in the sequence.
