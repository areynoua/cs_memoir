...
% names
\newcommand{\namePN} {\ensuremath{\mathcal{N}}\xspace}
\newcommand{\namePPN}{\ensuremath{\mathcal{S}}\xspace}
% bodies
\newcommand{\bodyPN} {\tuple{\places, \transitions, \mari}}
\newcommand{\bodyPPN}{\tuple{\places, \transitions, \parameters, \mari}}
\newcommand{\bodyNonMarkedPN} {\tuple{\places, \transitions}}
\newcommand{\bodyNonMarkedPPN}{\tuple{\places, \transitions, \parameters}}
% defs
\newcommand{\defPN} {\namePN  = \bodyPN}
\newcommand{\defPPN}{\namePPN = \bodyPPN}
\newcommand{\defNonMarkedPN} {\namePN  = \bodyNonMarkedPN}
\newcommand{\defNonMarkedPPN}{\namePPN = \bodyNonMarkedPPN}
...
\NewDocumentCommand{\effect}{ m O{} }{\Effect(#1)%
  \ifthenelse{\equal{\detokenize{#2}}{\detokenize{}}}{}
  {(#2)}}
...
\NewDocumentCommand{\bodySeq}{ O{\sit} m m }{(#1_{#2}, \dots, #1_{#3})}
\NewDocumentCommand{\bodyInfSeq}{ O{\sit} O{0} O{1} }{(#1_{#2}, #1_{#3}, \dots)}
\newcommand{\bodySeqt}[2]{\bodySeq[\transition]{#1}{#2}}
\newcommand{\bodySeqm}[2]{\bodySeq[\mar]{#1}{#2}}
\NewDocumentCommand{\defInfSeq}{ O{\seq} O{\sit} O{0} O{1} }{#1 = \bodyInfSeq[#2][#3][#4]}
